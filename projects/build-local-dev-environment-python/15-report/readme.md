...
Convert your dictionary of characters into a list and then use the [.sort()](https://python-reference.readthedocs.io/en/latest/docs/list/sort.html) method.

You can use a string's [.isalpha()](https://python-reference.readthedocs.io/en/latest/docs/str/isalpha.html) method to check if a string only contains characters from the alphabet.
