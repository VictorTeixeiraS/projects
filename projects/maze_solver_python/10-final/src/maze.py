    ...
    def _break_walls_r(self, i, j):
        ...
        while True:
            ...
            if i > 0 and not self._cells[i - 1][j].visited:
                next_i_list.append(i - 1)
                next_j_list.append(j)
            ...
            if j > 0 and not self._cells[i][j - 1].visited:
                next_i_list.append(i)
                next_j_list.append(j - 1)
                possible_direction_indexes += 1
            # down
            ...
            next_i = next_i_list[direction_index]
            next_j = next_j_list[direction_index]
